package com.example.datagreenmovil.DAO.Evaluaciones.MstObjetivosEvaluables;
...
@Entity(
        tableName = "mst_ObjetivosEvaluables",
        foreignKeys = {
                ...
                @ForeignKey(entity = MstOrganosPlanta.class, parentColumns = "Id", childColumns = "IdOrganoPlanta")
        }
)

public class MstObjetivosEvaluables {
    @PrimaryKey
    @NonNull
    private String Id;
    @NonNull
    private String Dex;
    private String IdOrganoPlanta;
    @NonNull
    ...
    public String getIdOrganoPlanta() {
        return IdOrganoPlanta;
    }

    public void setIdOrganoPlanta(String idOrganoPlanta) {
        IdOrganoPlanta = idOrganoPlanta;
    }
