package com.example.datagreenmovil.DAO.Evaluaciones.MstUnidadesMedida;
...
@Entity(tableName = "mst_UnidadesMedida",
        ...
        public class MstUnidadesMedida {
    @PrimaryKey
    @NonNull private String Id;
    @NonNull private String Dex;
    @NonNull private String Abreviatura;
