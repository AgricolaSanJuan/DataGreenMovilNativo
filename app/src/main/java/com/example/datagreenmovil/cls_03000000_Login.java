...
//        OBTENER VALORES DE LOGIN GUARDADOS EN CACHÉ
    ...
    private void referenciarControles() {
        ...
        //METER CODIGO PROPIO DE CADA ACTIVIDAD DESPUES DE ESTA LINEA
        //...
        etx_Usuario = findViewById(R.id.c003_etx_Usuario_v);
        etx_Password = findViewById(R.id.c003_etx_Password_v);
        c003_spi_Empresa = findViewById(R.id.c003_spi_Empresa_v);
...
//            objSqlite.guardarConfiguracionLocal(objConfLocal);
                ...
                sweetAlertDialog.dismissWithAnimation();
                Swal.warning(this, "PROHIBIDO", "La contraseña no es correcta", 2000);
//                        binding.switchModoPacking.setChecked(!b);
            }
        });
